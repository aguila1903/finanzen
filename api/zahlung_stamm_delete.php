...
$sqlQuery = "Delete from zahlungsmittel where ID = $ID; "
//        . " Update einausgaben set zahlungsmittel_id = NULL where zahlungsmittel_id = $ID;"
;
...
/*
 * *************************** Tabelle einausgaben anpassen ********************
 */
$sqlQuery = "Update einausgaben set zahlungsmittel_id = NULL where zahlungsmittel_id = $ID; ";
